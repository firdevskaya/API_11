...
//3.yol
        ...
        JSONObject expectedDataMapjsonObject= expectedObj.setUpPostReqBodyByUsingJSONObject();
        System.out.println(expectedDataMapjsonObject);
   softAssert.assertEquals(json.getString("data.name"),expectedDataMapjsonObject.getString("name"));
